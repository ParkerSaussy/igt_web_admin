                    ...
                    <div class="col-sm-4">
                       <div class="page-header float-left">
                          <div class="page-title">
                             <h1> <?php echo $data[0]->user['first_name'] . ' ' . $data[0]->user['last_name']; ?>'s Trip Details</strong></h1>
                          </div>
                       </div>
                    </div>
                    <div class="col-sm-8">
                       <div class="page-header float-right">
                          <div class="page-title">
                             <ol class="breadcrumb text-right">
                                ...
                                <li><a href="{{URL('users/userTrips/'.$id)}}"><?php echo $data[0]->user['first_name'] . ' ' . $data[0]->user['last_name']; ?>'s Trips</a></li>
