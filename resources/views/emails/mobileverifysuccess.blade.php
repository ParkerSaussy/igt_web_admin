                ...
                <table style="width:100%; border-spacing:0; padding: 20px; background-color: #fafafa;" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="margin: 0; color:#131B4C; font-size: 16px; line-height: 24px; font-family: 'Poppins', sans-serif; font-weight: 400;">
                            ...
                            <p>We are pleased to inform you that your mobile number has been successfully verified with ItsGoTime.</p>
                            <p>With your verified mobile number, you can now enjoy access to various features on our platform.</p>
                            
                            <p>Thank you for choosing ItsGoTime.</p>
                                <p>Best regards,<br>
                                ItsGoTime Team<br>
                            </p>
                        </td>
