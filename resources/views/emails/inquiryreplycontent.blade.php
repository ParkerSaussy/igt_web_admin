                ...
                <table style="width:100%; border-spacing:0; padding: 20px; background-color: #fafafa;" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="margin: 0; color:#131B4C; font-size: 16px; line-height: 24px; font-family: 'Poppins', sans-serif; font-weight: 400;">
                            <h2>Dear <?php echo $dynamicData['first_name'];?> <?php echo $dynamicData['last_name'];?>,</h2>
                            <p>We appreciate your interest and have processed your inquiry. Here is our reply:</p>
                            <br>
                            <strong>Your Inquiry Message:</strong><br> <?php echo $dynamicData['old_message'];?>
                            <br><br> 
                            <strong>Solution Message:</strong><br> <?php echo $dynamicData['reply'];?> 
                            <br>
                            <p>Best regards,<br>
                            ItsGoTime Team
                        </td>
